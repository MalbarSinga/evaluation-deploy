...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__environments_environment_singa__ = __webpack_require__("./src/environments/environment.singa.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BookService = /** @class */ (function () {
    ...
    BookService.prototype.initialize = function () {
        var _this = this;
        this.httpClient.get(__WEBPACK_IMPORTED_MODULE_3__environments_environment_singa__["a" /* environment */].apiUrl).subscribe(function (data) {
...
/***/ "./src/environments/environment.singa.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
